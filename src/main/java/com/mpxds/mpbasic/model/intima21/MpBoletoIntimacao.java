...
@Entity
@Table(name = "mp_boleto_intimacao", indexes = {
		@Index(name = "idxOficio", columnList = "codigo_oficio"), 
		@Index(name = "idxProtocolo", columnList = "numero_intimacao"), 
		@Index(name = "idxcpfCnpj", columnList = "cpf_cnpj") 
		} )
public class MpBoletoIntimacao extends MpBaseEntity {
	//
	...
	@Temporal(TemporalType.TIMESTAMP)
    @Column(name = "data_protocolo", nullable = true, length = 10)
	...
	@Column(name = "fins_falimentares", nullable = false, length = 1)
	...
	@Column(name = "endosso", nullable = false, length = 1)
	...
	@Temporal(TemporalType.TIMESTAMP)
    @Column(name = "data_vencimento_titulo", nullable = false, length = 10)
	public Date getDataVencimentoTitulo() { return dataVencimentoTitulo; }
	public void setDataVencimentoTitulo(Date dataVencimentoTitulo) { 
																this.dataVencimentoTitulo = dataVencimentoTitulo; }

	@Column(name = "motivo_protesto", nullable = false, length = 300)
	...
	@Column(name = "nome_apresentante", nullable = false, length = 250)
	public String getNomeApresentante() { return nomeApresentante; }
	public void setNomeApresentante(String nomeApresentante) { this.nomeApresentante = nomeApresentante; }

	@Column(name = "nome_cedente", nullable = false, length = 250)
	...
	@Column(name = "nome_sacador", nullable = false, length = 250)
	...
	public String getCustas() { return custas; }
	public void setCustas(String custas) { this.custas = custas; }
	
	@NotNull(message = "Por favor, informe o VALOR SALDO")
	@Column(name = "valor_saldo", nullable = false, precision = 10, scale = 2)
	public BigDecimal getValorSaldo() { return valorSaldo; }
	public void setValorSaldo(BigDecimal valorSaldo) { this.valorSaldo = valorSaldo; }
	
	@Column(nullable = true, length = 900000)
	public String getBase64() { return this.base64; }
	public void setBase64(String newBase64) { this.base64 = newBase64; }
	...
	@Transient
	public String getDataDocumentoDMY() { 
		//
		return new SimpleDateFormat("dd/MM/yyyy").format(this.dataDocumento); 
	}
	
	@Transient
	public String getDataVencimentoDMY() { 
		//
		return new SimpleDateFormat("dd/MM/yyyy").format(this.dataVencimento); 
	}

	@Transient
	public String getDataProtocoloDMY() { 
		//
		return new SimpleDateFormat("dd/MM/yyyy").format(this.dataProtocolo); 
	}
	
	@Transient
	public String getDataDistribuicaoDMY() { 
		//
		return new SimpleDateFormat("dd/MM/yyyy").format(this.dataDistribuicao); 
	}
	
	@Transient
	public String getDataEmissaoDMY() { 
		//
		return new SimpleDateFormat("dd/MM/yyyy").format(this.dataEmissao); 
	}
	
	@Transient
	public String getDataVencimentoTituloDMY() { 
		//
		return new SimpleDateFormat("dd/MM/yyyy").format(this.dataVencimentoTitulo); 
	}
