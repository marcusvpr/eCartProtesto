...
@Entity
@Table(name = "mp_robot_log")
public class MpRobotLog extends MpBaseEntity {
	//
	private static final long serialVersionUID = 1L;

	private MpTipoRobot mpTipoRobot;
	...
	@Column(name = "mpTipo_robot", nullable = false, length = 10)
	public MpTipoRobot getMpTipoRobot() { return mpTipoRobot; }
	public void setMpTipoRobot(MpTipoRobot mpTipoRobot) { this.mpTipoRobot = mpTipoRobot; }
