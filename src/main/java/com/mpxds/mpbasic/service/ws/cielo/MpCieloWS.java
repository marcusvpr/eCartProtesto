...
public class MpCieloWS implements Serializable {
	//
	...
	private static final String URL_CIELO_WS = "/1/sales/";
	...
	public ClientResponse solicitarPagamento(PaymentRequest paymentRequest) throws Exception {
		...
		try {
			...
			WebResource webResource = client.resource(mpSeguranca.getCieloRequisicaoSandboxURL() + URL_CIELO_WS);
