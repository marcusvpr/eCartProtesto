...
public class MpPesquisaTitulosBean implements Serializable {
	...
	private List<MpTitulo> mpTituloList;
	...
	public void init() {
		...
		this.mpTituloList = new ArrayList<MpTitulo>();
	...
	public void pesquisaTitulo() {
		...
		this.mpTituloList = mpTitulos.mpTituloByOficioNumeroProtocoloList(mpCartorioOficioSel.getNumero(),
																								this.numeroIntimacao);
//		this.mpTituloList = mpTitulos.mpTituloByOficioDataProtocoloList(mpCartorioOficioSel.getNumero(), dataDe, dataAte);
		//
	}
	
	// ---
	
	public List<MpTitulo> getMpTituloList() { return mpTituloList; }
	public void setMpTituloList(List<MpTitulo> mpTituloList) { this.mpTituloList = mpTituloList; }
